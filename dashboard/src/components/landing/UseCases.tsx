const useCases = [
  {
    ...
    description: 'Deploy YOLOv8 to 50+ cameras on your assembly line. Update the model when defect patterns change — no production stoppage.',
  ...
  },
  {
    ...
    description: 'Push inventory detection models to 200 stores running Raspberry Pi cameras. Canary roll out store-by-store.',
  ...
  },
  {
    ...
    description: 'Deploy to 500 solar-powered field sensors with spotty connectivity. Offline-first means your models keep running.',
    chips: ['ARM', 'Intel NUC'],
    color: 'cyan',
  },
  {
    ...
    description: 'Update models across thousands of intersection cameras. Zero-downtime hot-swap keeps the city seeing.',
